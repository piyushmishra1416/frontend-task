...
const Landing = () => {
  return (
    <div className="flex mx-14  mt-[29px] w-screen ">
      <div className=" ">
        <div className="relative w-[55.1rem]  bg-black rounded-[16px]">
      ...
      <div className="w-[20.4375rem] h-[4.25rem] ml-5 rounded-2xl bg-primary-blue px-4 py-14 ">
